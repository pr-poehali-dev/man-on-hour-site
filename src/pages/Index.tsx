        ...
        <div className="container mx-auto relative z-10">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative animate-scale-in">
              <img 
                src="https://cdn.poehali.dev/projects/761ca3c7-9805-46e6-a2dd-e21a9373e18c/files/11b31fe5-6221-42ae-af9b-099ad85bd101.jpg"
        ...
        <div className="container mx-auto relative z-10">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1">
              <img 
                src="https://cdn.poehali.dev/projects/761ca3c7-9805-46e6-a2dd-e21a9373e18c/files/c4c08f16-4a6a-42b6-9909-fd947f735949.jpg"
                alt="Массаж"
                className="rounded-2xl shadow-2xl w-full"
              />
            </div>
